...
def get_array(n):
    ...
    for i in range(n):
        ...
        x0.append(b)
    return tuple(x0)
###TDO: this is just a copy of the old ui file, it needs to be rewritten, I won't be doing it for now because I intend to use calculus as an istrument for another project
